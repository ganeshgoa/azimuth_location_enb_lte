# Данная программа позволяет нарисовать месторасположение базовых станций LTE на карте Google Earth Pro на основе широты и долготы с учётом азимутов секторов.
